...
<div class="app-content content ">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Production</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ route('productions.index') }}">Productions</a>
                                    </li>
                            ...
                            <div class="card">
                                {{-- <div class="card-header border-bottom"> --}}
                                    <div class="row " style="padding-top: 6px">
                                        ...
                                        <div class="col-md-2">
                                            <a href="{{route('productions.create')}}" class=" btn btn-primary btn-gradient round  ">Create</a>
                                        </div>
                                    </div>
                                ...
                                <div class="card-datatable">
                                    <table class="datatables-ajax table table-responsive datatable_data">
                                        ...
                                        <tbody>
                                            @php  $i=1; @endphp
                                            @foreach($productions as $key => $val)
                                            <tr>
                                                <th scope="row">{{ $i }}</th>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="{{route('productions.edit',$val->id)}}">
                                                    ...
                                                    <div class="modal fade modal-danger text-start" id="danger_ke{{ $val->id }}" tabindex="-1" aria-labelledby="myModalLabel120" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{route('productions.destroy',$val->id)}}" method="POST">
                                                                        @csrf
                                                                        @method('delete')
                                    ...
                                    @include('_pagination', ['data' => $productions])
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function ChangeStatusActive (id){
            $.ajax({
                url: "{{ route('productions.change_status') }}",
                type: 'POST',
                dataType: 'json',
                data: {
