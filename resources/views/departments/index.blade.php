...
<div class="app-content content ">
                            ...
                            <div class="card">
                                {{-- <div class="card-header border-bottom"> --}}
                                    <div class="row " style="padding-top: 6px">
                                        ...
                                        <div class="col-md-2">
                                            <a href="{{route('departments.create')}}" class=" btn btn-primary btn-gradient round  ">Create</a>
                                        </div>
                                    </div>
                                ...
                                <div class="card-datatable">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="{{route('departments.edit',$val->id)}}">
                                    ...
                                    @include('_pagination', ['data' => $departments])
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function ChangeStatusActive (id){
            $.ajax({
                url: "{{ route('departments.change_status') }}",
                type: 'POST',
                dataType: 'json',
                data: {
